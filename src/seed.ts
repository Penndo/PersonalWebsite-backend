...
async function seed(): Promise<void> {
  ...
  if (existingTabs === 0) {
    const tabs = tabRepo.create([
      { key: 'works', label: '作品', order: 1, enabled: true },
    ...
    const projects = projectRepo.create([
      {
        ...
        routeId: 'hooinn',
        summary:
          'Hooinn（呼应）是一款聚焦于进出口物流服务的 UGC 平台，为用户提供内容分享与交流服务...',
        content:
          'Hooinn（呼应）是一款聚焦于进出口物流服务的 UGC 平台，为用户提供内容分享与交流服务，连接全球物流从业者，打造专业的物流知识社区。',
        coverUrl: '',
      ...
      },
      {
        ...
        routeId: 'pub',
        summary:
          'PUB（发行系统）是一款聚焦于进出口物流服务的 UGC 平台，为用户提供内容分发与管理服务...',
        content:
          'PUB（发行系统）是一款聚焦于进出口物流服务的内容分发与管理系统，为企业提供高效的内容管理、审核和分发能力。',
        coverUrl: '',
      ...
      },
      {
        ...
        summary:
          '成都ezc平台是为了解决公安与政府之间地名地址与信息同步问题而构建的统一服务平台...',
        content:
          '成都ezc平台是为了解决公安与政府之间地名地址与信息同步问题而构建的统一服务平台。',
        coverUrl: '',
      ...
      },
      {
        ...
        summary:
          '成都ezc平台是为了解决公安与政府之间地名地址与信息同步问题而构建的统一服务平台...',
        content:
          '智慧堆场管理系统，通过数字化手段实现堆场资源的高效调度和可视化管理。',
        coverUrl: '',
    ...
    const articles = articleRepo.create([
      {
        ...
        summary:
          '如何从零开始构建一套完整的设计系统，包括设计语言、组件库和文档规范...',
        content:
          '如何从零开始构建一套完整的设计系统，包括设计语言、组件库和文档规范...',
        coverUrl: '',
      ...
      },
      {
        ...
        summary:
          '深入探讨用户体验设计的核心方法论，从用户研究到设计验证的完整流程...',
        content:
          '深入探讨用户体验设计的核心方法论，从用户研究到设计验证的完整流程...',
        coverUrl: '',
      ...
      },
      {
        ...
        summary:
          '产品思维与设计思维的区别与融合，如何在项目中平衡商业目标与用户需求...',
        content:
          '产品思维与设计思维的区别与融合，如何在项目中平衡商业目标与用户需求...',
        coverUrl: '',
      ...
      },
      {
        ...
        summary:
          '移动端应用交互设计的最佳实践，包括手势设计、动效设计和用户体验优化...',
        content:
          '移动端应用交互设计的最佳实践，包括手势设计、动效设计和用户体验优化...',
        coverUrl: '',
    ...
    const plugins = pluginRepo.create([
      {
        ...
        content:
          '自动从Figma设计文件生成设计令牌的工具插件，支持导出为CSS、JSON、SCSS等多种格式...',
        repositoryUrl: '',
        downloadUrl: '',
        version: '2.1.0',
      ...
      },
      {
        ...
        content:
          '快速创建和管理配色方案的Figma插件，提供智能配色建议和色彩和谐工具...',
        repositoryUrl: '',
        downloadUrl: '',
        version: '1.5.2',
      ...
      },
      {
        ...
        content:
          '图标管理和导出工具，支持多种格式和尺寸，帮助设计师高效管理图标资源...',
        repositoryUrl: '',
        downloadUrl: '',
        version: '3.0.1',
